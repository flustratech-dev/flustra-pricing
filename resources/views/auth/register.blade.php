    ...
    <div class="w-full max-w-5xl bg-[#FFFDF9] rounded-[2.5rem] shadow-[0_25px_60px_-15px_rgba(179,84,18,0.15)] overflow-hidden flex flex-col md:flex-row min-h-[600px] border border-[#F1E4D0]/50">
        ...
        <div class="w-full md:w-1/2 p-8 sm:p-12 md:p-16 flex flex-col justify-center bg-[#FFFDF9]">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <!-- Name -->
                <div>
                    <label for="name" class="block text-[11px] font-bold text-[#8C827A] tracking-[0.1em] mb-1.5">NAMA LENGKAP</label>
                    <div class="relative flex items-center">
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" 
                            ...
                            class="w-full bg-white border border-[#EADFCF] rounded-xl py-3 pl-11 pr-4 text-[#4A403A] text-sm placeholder-[#BFB6AE] focus:outline-none focus:border-[#B35412] focus:ring-2 focus:ring-[#B35412]/20 transition-all duration-200 shadow-sm" />
                    </div>
                    @if ($errors->has('name'))
                ...
                <!-- Email Address -->
                <div>
                    <label for="email" class="block text-[11px] font-bold text-[#8C827A] tracking-[0.1em] mb-1.5">ALAMAT EMAIL</label>
                    <div class="relative flex items-center">
                        <span class="absolute left-4 text-[#BFB6AE]">
                            <!-- SVG Mail Icon -->
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                ...
                <!-- Password -->
                <div>
                    <label for="password" class="block text-[11px] font-bold text-[#8C827A] tracking-[0.1em] mb-1.5">KATA SANDI</label>
                    <div class="relative flex items-center">
                        <span class="absolute left-4 text-[#BFB6AE]">
                            <!-- SVG Lock Icon -->
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                        ...
                        <input id="password" type="password" name="password" required autocomplete="new-password" 
                            placeholder="••••••••" 
                            class="w-full bg-white border border-[#EADFCF] rounded-xl py-3 pl-11 pr-11 text-[#4A403A] text-sm placeholder-[#BFB6AE] focus:outline-none focus:border-[#B35412] focus:ring-2 focus:ring-[#B35412]/20 transition-all duration-200 shadow-sm" />
                        
                        <!-- Toggle Password Visibility -->
                        <button type="button" onclick="togglePasswordVisibility('password', 'eye-icon-reg')" class="absolute right-4 text-[#BFB6AE] hover:text-[#B35412] transition-colors focus:outline-none">
                ...
                <!-- Confirm Password -->
                <div>
                    <label for="password_confirmation" class="block text-[11px] font-bold text-[#8C827A] tracking-[0.1em] mb-1.5">KONFIRMASI KATA SANDI</label>
                    <div class="relative flex items-center">
                        <span class="absolute left-4 text-[#BFB6AE]">
                            <!-- SVG Lock Icon -->
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                        ...
                        <!-- Toggle Password Visibility -->
                        <button type="button" onclick="togglePasswordVisibility('password_confirmation', 'eye-icon-confirm')" class="absolute right-4 text-[#BFB6AE] hover:text-[#B35412] transition-colors focus:outline-none">
                ...
                <div class="flex items-start">
                    ...
                    <label for="terms" class="ml-3 text-xs text-[#7A6E67] leading-relaxed cursor-pointer font-sans">
                ...
                <div>
                    <button type="submit" 
                        class="w-full bg-[#B35412] hover:bg-[#9C430B] text-white font-semibold py-3 px-4 rounded-xl shadow-[0_4px_12px_rgba(179,84,18,0.25)] hover:shadow-[0_6px_16px_rgba(179,84,18,0.35)] focus:outline-none focus:ring-2 focus:ring-[#B35412]/50 active:scale-[0.98] transition-all duration-150 text-center text-sm font-sans mt-2">
                        Daftar Akun
                    </button>
                </div>
            </form>
            ...
            <!-- Bottom Navigation -->
            <p class="text-center text-xs sm:text-sm text-[#7A6E67] font-sans mt-6">
                Sudah memiliki akun? <a href="{{ route('login') }}" class="font-bold text-[#B35412] hover:text-[#9C430B] hover:underline transition-all">Masuk Sekarang</a>
            </p>
